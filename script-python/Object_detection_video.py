######## Reconocimiento de Mascarilla por Video #########
...
# Nombre del directorio que contiene el modelo y el video por analizar
MODEL_NAME = 'inference_graph'
VIDEO_NAME = 'test.mp4' #Nombre del archivo del video
...
# Define el path completo del video
...
while(video.isOpened()):
    ...
    cv2.imshow('S.D.M.V.A - Video', frame)
