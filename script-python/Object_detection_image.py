...
# Nombre del directorio que contiene el modelo y la imagen por analizar
MODEL_NAME = 'inference_graph'
IMAGE_NAME = 'test.png' #Nombre del archivo de la imagen
...
# Define el path completo de la imagen
...
category_index = label_map_util.create_category_index(categories) #Índice de las clases
...
# Una vez ya dibujado el resultado de la imagen, mostrarlo en pantalla
cv2.imshow('S.D.M.V.A - Imagen', image)

# Al presionar una tecla se cierra la ventana
cv2.waitKey(0)
